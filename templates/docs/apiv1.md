...
------------------------------------------------------|-------
**Checks**|
[List existing checks](#list-checks)                  | `GET API_ROOT/v1/checks/`
[Get a single check](#get-check)                      | `GET API_ROOT/v1/checks/<uuid>`<br>`GET API_ROOT/v1/checks/<unique_key>`
[Create a new check](#create-check)                   | `POST API_ROOT/v1/checks/`
[Update an existing check](#update-check)             | `POST API_ROOT/v1/checks/<uuid>`
[Pause monitoring of a check](#pause-check)           | `POST API_ROOT/v1/checks/<uuid>/pause`
[Resume monitoring of a check](#resume-check)         | `POST API_ROOT/v1/checks/<uuid>/resume`
[Delete check](#delete-check)                         | `DELETE API_ROOT/v1/checks/<uuid>`
**Pings**|
[List check's logged pings](#list-pings)              | `GET API_ROOT/v1/checks/<uuid>/pings/`
[Get a ping's logged body](#ping-body)                | `GET API_ROOT/v1/checks/<uuid>/pings/<n>/body`
**Flips**|
[List check's status changes](#list-flips)   | `GET API_ROOT/v1/checks/<uuid>/flips/`<br>`GET API_ROOT/v1/checks/<unique_key>/flips/`
**Integrations**|
[List existing integrations](#list-channels) | `GET API_ROOT/v1/channels/`
**Badges**|
[List project's badges](#list-badges)                  | `GET API_ROOT/v1/badges/`
...
:   Filters the checks and returns only the checks that are tagged with the
    ...
    `API_ROOT/v1/checks/?tag=foo&tag=bar`
...
```bash
curl --header "X-Api-Key: your-api-key" API_ROOT/v1/checks/
```
  ...
  "checks": [
    {
      ...
      "update_url": "API_ROOT/v1/checks/31365bce-8da9-4729-8ff3-aaa71d56b712",
      "pause_url": "API_ROOT/v1/checks/31365bce-8da9-4729-8ff3-aaa71d56b712/pause",
      "resume_url": "API_ROOT/v1/checks/31365bce-8da9-4729-8ff3-aaa71d56b712/resume",
    ...
    },
    {
      ...
      "update_url": "API_ROOT/v1/checks/803f680d-e89b-492b-82ef-2be7b774a92d",
      "pause_url": "API_ROOT/v1/checks/803f680d-e89b-492b-82ef-2be7b774a92d/pause",
      "resume_url": "API_ROOT/v1/checks/803f680d-e89b-492b-82ef-2be7b774a92d/resume",
      "channels": "1bdea468-03bf-47b8-ab27-29a9dd0e4b94,51c6eb2b-2ae1-456b-99fe-6f1e0a36cd3c",
      "schedule": "15 5 * * *",
      "tz": "UTC"
    }
...
`GET API_ROOT/v1/checks/<uuid>`<br>
`GET API_ROOT/v1/checks/<unique_key>`
...
```bash
curl --header "X-Api-Key: your-api-key" API_ROOT/v1/checks/<uuid>
```
...
```json
{
  ...
  "filter_subject": false,
  "filter_body": false,
  "pause_url": "API_ROOT/v1/checks/f618072a-7bde-4eee-af63-71a77c5723bc/pause",
  "resume_url": "API_ROOT/v1/checks/f618072a-7bde-4eee-af63-71a77c5723bc/resume",
  "ping_url": "PING_ENDPOINTf618072a-7bde-4eee-af63-71a77c5723bc",
  "status": "new",
  "tags": "prod www",
  "timeout": 3600,
  "update_url": "API_ROOT/v1/checks/f618072a-7bde-4eee-af63-71a77c5723bc",
}
```

## Update an Existing Check {: #update-check .rule }

`POST API_ROOT/v1/checks/<uuid>`
...
```bash
curl API_ROOT/v1/checks/f618072a-7bde-4eee-af63-71a77c5723bc \
    --header "X-Api-Key: your-api-key" \
    --data '{"name": "Backups", "tags": "prod www", "timeout": 3600, "grace": 60}'
```
...
`POST API_ROOT/v1/checks/<uuid>/pause`
...
```bash
curl API_ROOT/v1/checks/0c8983c9-9d73-446f-adb5-0641fdacc9d4/pause \
...
`POST API_ROOT/v1/checks/<uuid>/resume`
...
```bash
curl API_ROOT/v1/checks/0c8983c9-9d73-446f-adb5-0641fdacc9d4/resume \
    --request POST --header "X-Api-Key: your-api-key" --data ""
```
...
`DELETE API_ROOT/v1/checks/<uuid>`
...
`GET API_ROOT/v1/checks/<uuid>/pings/`
...
```bash
curl API_ROOT/v1/checks/f618072a-7bde-4eee-af63-71a77c5723bc/pings/ \
    --header "X-Api-Key: your-api-key"
```
...
`GET API_ROOT/v1/checks/<uuid>/pings/<n>/body`
...
```bash
curl API_ROOT/v1/checks/f618072a-7bde-4eee-af63-71a77c5723bc/pings/397/body \
    --header "X-Api-Key: your-api-key"
```

## List check's status changes {: #list-flips .rule }

`GET API_ROOT/v1/checks/<uuid>/flips/`<br>
`GET API_ROOT/v1/checks/<unique_key>/flips/`
...
:   Returns the flips from the last `value` seconds
    ...
    `API_ROOT/v1/checks/<uuid|unique_key>/flips/?seconds=3600`
...
:   Returns flips that are newer than the specified UNIX timestamp.
    ...
    `API_ROOT/v1/checks/<uuid|unique_key>/flips/?start=1592214380`
...
:   Returns flips that are older than the specified UNIX timestamp.
    ...
    `API_ROOT/v1/checks/<uuid|unique_key>/flips/?end=1592217980`
...
```bash
curl API_ROOT/v1/checks/f618072a-7bde-4eee-af63-71a77c5723bc/flips/ \
    --header "X-Api-Key: your-api-key"
```
...
```bash
curl --header "X-Api-Key: your-api-key" API_ROOT/v1/channels/
```
...
```bash
curl --header "X-Api-Key: your-api-key" API_ROOT/v1/badges/
```
